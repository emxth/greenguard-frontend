...
function EditFuelCost() {
    ...
    useEffect(() => {   
        axios.get(`http://localhost:8080/FuelCost/getOneFuelCost/${costID}`)
            .then((response) => {
    ...
    const handleUpdate = (e) => {
        ...
        axios.put(`http://localhost:8080/FuelCost/updateFuelCost/${costID}`, updatedFuel)
            .then(() => {
        ...
        <div className="emc-container">
            ...
            <div className="emc-right-form">
                <form className="emc-form-layout" onSubmit={handleUpdate}>
                    <h2 className="emc-topic">Edit Fuel Cost</h2>

                    <div className="emc-form-group">
                        <label className="emc-form-label">Truck Number</label><br />
                        <input type="text" className="emc-form-control" value={truck_RegNumber} readOnly />
                    </div>

                    <div className="emc-form-group">
                        <label className="emc-form-label">Fuel Date</label><br />
                        <input type="date" className="emc-form-control1" value={fuelDate}
                            onChange={handleFuelDateChange} required />
                        {fuelDateError && <div style={{ color: 'red' }}>{fuelDateError}</div>}
                    </div>

                    <div className="emc-form-group">
                        <label className="emc-form-label">Fuel Type</label><br />
                        <select className="emc-form-control3" value={fuelType}
                    ...
                    <div className="emc-form-group">
                        <label className="emc-form-label">Fuel Cost (LKR)</label><br />
                        <input type="text" className="emc-form-control" value={fuelCost}
                    ...
                    <div className="emc-form-group">
                        <label className="emc-form-label">Litres</label><br />
                        <input type="text" className="emc-form-control" value={litres}
