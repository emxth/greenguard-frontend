...
//                     <h2 className="header">Truck Details</h2>
...
//                     />
//                     <button className="searchBtn" onClick={searchTruck}>Search</button>
//                     <button className="resetBtn" onClick={() => setTrucks(allTrucks)}>Reset</button>

//                     <table className="truckTable">
//                         <thead>
//                             <tr>
//                                 <th className="tableHeader">Reg Number</th>
//                                 <th className="tableHeader">Model</th>
//                                 <th className="tableHeader">Capacity</th>
//                                 <th className="tableHeader">Insurance Expiry</th>
//                                 <th className="tableHeader">Inspection Date</th>
//                                 <th className="tableHeader">Collection Center</th>
//                                 <th className="tableHeader">Driver ID</th>
...
//                                         <td className="statusCell">{truck.isActive ? "Active" : "Inactive"}</td>
//                                         <td>
//                                             <button onClick={() => NavigateToViewTruck(truck.RegNumber)} className="viewBtn">View</button>
//                                             <button onClick={() => deleteTruck(truck.RegNumber)} className="deleteBtn">Delete</button>
//                                         </td>
//                                     </tr>
//                                 ))
//                             ) : (
...
//                     <button className="generateBtn" onClick={handleGenerateTruckPDF}>Generate Report</button>
//                     <button className="generateBtn2" onClick={handleGenerateActiveTruckPDF}>Generate Active Truck Report</button>
//                 </div>
//             </div>
//         </div>
//     );
