...
// import "./styles/MaintenanceCost.css"; // Make sure the path is correct
...
//         const filteredTrucks = allTruckCosts.filter(truckCosts =>
//             truckCosts.Truck_RegNum.toLowerCase().includes(searchRegNum.toLowerCase())
//         );
//         setTruckCost(filteredTrucks);
//     };
...
//             <BackBtn />
//             <h2 className="truckCostTitle">Truck Cost Details</h2>
//             <input
...
//             <button className="truckCostresetBtn" onClick={() => setTruckCost(allTruckCosts)}>Reset</button>
...
//             </table>
//             <br />
//             <button className="truckCostGenerateBtn" type="button" onClick={handleGeneratePDF}>Generate Report</button>
//             {/* enable this button once searched */}
//             <button className="truckCostGenerateBtn2" type="button">Generate Report for Specific truck</button>
//         </div>
//     );
// }
...
function ViewTruckCosts() {
    ...
    const searchTruckCost = () => {
        ...
        axios.get(`http://localhost:8080/Maintenance/SearchTruckCosts/${searchRegNum}`)
            .then((response) => {
