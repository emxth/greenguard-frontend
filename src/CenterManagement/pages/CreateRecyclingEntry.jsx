...
const CreateRecyclingEntry = () => {
  ...
  const handleSaveEntry = () => {
    ...
    setLoading(true);
    axios
      .post("http://localhost:8081/recycling", data)
      .then(() => {
        setLoading(false);
        enqueueSnackbar("Recycling Entry Created successfully", { variant: "success" });
        alert("Recycling Entry Created successfully");
        navigate("/center");
      })
      .catch((error) => {
        setLoading(false);
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="max-w-3xl mx-auto">
        <BackButton />
        <h1 className="text-4xl font-bold text-green-800 mb-8">Create Recycling Entry</h1>
        {loading ? <Spinner /> : ""}
...
export default CreateRecyclingEntry;