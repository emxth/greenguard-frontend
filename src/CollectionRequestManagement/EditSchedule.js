...
//     //Get data of specific schedule
//     useEffect(() => {
//         axios.get(`http://localhost:8070/shedulePickup/getScheduleInfo/${ScheduleID}`)
//             .then((response) => {
...
//         axios.put(`http://localhost:8070/shedulePickup/updateSchedule/${ScheduleID}`, updateSchedule)
//             .then(() => {
...
//                             <input type="text" id="scheduleID" value={ScheduleID} disabled />

//                             <label htmlFor="pickupID">Pickup ID:</label>
//                             <input type="text" id="pickupID" value={pickUpID} disabled />

//                             <label htmlFor="truckRegNumber">Truck Reg Number:</label>
//                             <input type="text" id="truckRegNumber" value={truck_RegNumber} disabled />

//                             <label htmlFor="driverID">Driver ID:</label>
//                             <input type="text" id="driverID" value={driverId} readOnly />
...
//                                 required
//                             />
//                             {errors.scheduleTime && <p className="error-message">{errors.scheduleTime}</p>}
