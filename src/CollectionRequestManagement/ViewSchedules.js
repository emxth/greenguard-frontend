...
//                 setAllSchedules(response.data); // keep original data for reset
//                 setLoading(false);
//             })
//             .catch((err) => {
...
//         axios.get(`http://localhost:8070/shedulePickup/SearchSchedule/${searchDate}`)
//             .then((res) => {
...
//         generatePDFReport(pickUpSchedules, "All Schedules Report");
//     };
...
//                                         <button className="edit-btn" onClick={() => UpdateSchedule(schedule.Schedule_ID)}>Edit</button>
//                                         <button className="delete-btn" onClick={() => DeleteSchedule(schedule.Schedule_ID)}>Delete</button>
//                                     </td>
//                                 </tr>
//                             ))
//                         ) : (
...
//                 </table>
//             </div>
//             <button className="search-btn" onClick={handleGenerateAll}>Generate Report</button>
//             <button className="search-btn" onClick={handleGeneratePastMonth} style={{marginLeft:"20px"}}>Generate for past 1 month</button>
//         </div>
//     );
// }
