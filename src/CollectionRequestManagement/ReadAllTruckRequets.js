...
// import autoTable from "jspdf-autotable"; // Import autoTable this way
...
//         axios.get(`http://localhost:8070/requestTruck/searcReqTruck/${searchReqID}`)
//             .then((res) => {
//                 setTruckrequests(res.data.requests); // expects array
//             })
//             .catch((err) => {
...
//         // Show total record count below the title
//         doc.setFontSize(12);
...
//         autoTable(doc, {
//             head: [
//                 ["#", "Request ID", "Truck Number", "Driver ID", "Priority", "Request Date", "Capacity", "Location", "Status"]
//             ],
//             body: tableData,
//             startY: 30 // Adjust startY to give space for title and total count
//         });
...
//                                         <button className="edit-btn" onClick={() => EditTruckRequest(requests.RequestID)}>Edit</button>
//                                         <button className="delete-btn" onClick={() => DeleteTruckRequest(requests.RequestID)}>Delete</button>
//                                     </td>
//                                 </tr>
//                             ))
//                         ) : (
...
//                 </table>
//             </div>
//             <button className="search-btn" onClick={handleGenerateAssignedReport}>Generate Assigned Truck Report</button>
//             <button className="search-btn" onClick={handleGenerateRequestedReport} style={{ marginLeft: "20px" }}>Generate Requested Truck Report</button>
//         </div>
//     );
// }
